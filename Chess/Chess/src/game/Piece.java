...
public abstract class Piece {
	...
	static {
		images.put(WP, Toolkit.getDefaultToolkit().getImage(
				"C:\\Users\\akars\\Documents\\Eclipse Projects\\Chess\\OldChess\\resources\\images\\Pawntrue.png"));
		images.put(BP, Toolkit.getDefaultToolkit().getImage(
				"C:\\Users\\akars\\Documents\\Eclipse Projects\\Chess\\OldChess\\resources\\images\\Pawnfalse.png"));

		images.put(WR, Toolkit.getDefaultToolkit().getImage(
				"C:\\Users\\akars\\Documents\\Eclipse Projects\\Chess\\OldChess\\resources\\images\\Rooktrue.png"));
		images.put(BR, Toolkit.getDefaultToolkit().getImage(
				"C:\\Users\\akars\\Documents\\Eclipse Projects\\Chess\\OldChess\\resources\\images\\Rookfalse.png"));

		images.put(WB, Toolkit.getDefaultToolkit().getImage(
				"C:\\Users\\akars\\Documents\\Eclipse Projects\\Chess\\OldChess\\resources\\images\\Bishoptrue.png"));
		images.put(BB, Toolkit.getDefaultToolkit().getImage(
				"C:\\Users\\akars\\Documents\\Eclipse Projects\\Chess\\OldChess\\resources\\images\\Bishopfalse.png"));

		images.put(WN, Toolkit.getDefaultToolkit().getImage(
				"C:\\Users\\akars\\Documents\\Eclipse Projects\\Chess\\OldChess\\resources\\images\\Knighttrue.png"));
		images.put(BN, Toolkit.getDefaultToolkit().getImage(
				"C:\\Users\\akars\\Documents\\Eclipse Projects\\Chess\\OldChess\\resources\\images\\Knightfalse.png"));

		images.put(WQ, Toolkit.getDefaultToolkit().getImage(
				"C:\\Users\\akars\\Documents\\Eclipse Projects\\Chess\\OldChess\\resources\\images\\Queentrue.png"));
		images.put(BQ, Toolkit.getDefaultToolkit().getImage(
				"C:\\Users\\akars\\Documents\\Eclipse Projects\\Chess\\OldChess\\resources\\images\\Queenfalse.png"));

		images.put(WK, Toolkit.getDefaultToolkit().getImage(
				"C:\\Users\\akars\\Documents\\Eclipse Projects\\Chess\\OldChess\\resources\\images\\Kingtrue.png"));
		images.put(BK, Toolkit.getDefaultToolkit().getImage(
				"C:\\Users\\akars\\Documents\\Eclipse Projects\\Chess\\OldChess\\resources\\images\\Kingfalse.png"));
	...
	/**
	 * This method does not check for checks. It simply says whether the piece can
	 * move to a location based on the piece's nature and the board conditions
	 * 
	 * @param board
	 * @param move
	 * @return
