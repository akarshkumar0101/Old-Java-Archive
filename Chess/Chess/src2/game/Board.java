...
public class Board {
	...
	/**
	 * Will do the move without checking anything;<br>
	 * <br>
	 * Can enter move like: int[] coordinate1, int[] coordinate2<br>
	 * or can enter move like: int[][] move
	 * 
	 * @param move
	 *            should be int[2][2] - normal coordinate and move rep
	 */
	public void doMove(int[]... move) {
		board[move[1][0]][move[1][1]] = board[move[0][0]][move[0][1]];
		board[move[0][0]][move[0][1]] = Piece.NONE;
	}
	 ...
	 * @return
	 */
	public boolean playerCanMakeMove(int[]... move) {
		if (Piece.pieceCanMove(this, move)) {
			Board board = new Board(this);
			int side = board.board[move[0][0]][move[0][1]];
			board.doMove(move);
	...
	public boolean isInCheck(int piece) {
		...
		for (int[] locale : ALL_LOCALES) {
			if (Piece.pieceCanMove(this, locale, kingLocale))
				return true;
		}
		return false;
	}
