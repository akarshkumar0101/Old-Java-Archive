...
import ui.view.StudentInfoView;
...
public class FGFrame extends JFrame implements WindowListener, MouseListener {
	...
	public final StudentInfoView stuinfoview;
	public final AdminView aview;
	public final MainView mview;
	public final StudentView stuview;
	...
	public FGFrame() {
		...
		stuinfoview = new StudentInfoView(this);
	 ...
	 * button<br>
	 * This method shows the param view and sets it as the current view and makes
	 * sure everything works according to the view<br>
