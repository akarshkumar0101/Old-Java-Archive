...
public class SettingsView extends View {
	...
	private class ContentPanel extends JScrollPane {
		...
		private void setupText(AppPrefs prefs) {
			...
			if (prefs == null) {
				...
				txtLocaleField.setText(Application.appPath.getAbsolutePath() + "\\student_data");

			} else {
				adminPassField.setText(prefs.adminPassWord);
				fullScreenBox.setSelected(prefs.fullScreen);
				txtLocaleField.setText(prefs.getCurrentSaveDir().getAbsolutePath());
	...
	public void applyChanges() throws Exception {
		...
		ap.dataDir = new File(contentPanel.txtLocaleField.getText());
