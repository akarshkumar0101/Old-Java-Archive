...
public final class Application {
	...
	public static final String STUEXTENSION = ".asmsastu";
	public static final String PREFEXTENSION = ".asmsapref";

	public static final File appPath = new File(System.getenv("appdata") + "/ASMSA RLO/");
