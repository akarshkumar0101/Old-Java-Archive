...
// Util.formatName(this) + ": Signed In at " +
// Util.normalFormat.format(newsession.getSigninTime()));
// }
// }
//
// public void signout() {
...
// + Util.normalFormat.format(sessions.get(sessions.size() -
// 1).getSignoutTime()));
// }
//
...
// if (Application.logFileStream != null) {
// Application.logFileStream.println(
// "* Last signout did was not recorded because the session was under a minute
// in length *");
// }
// }
//
...
// || (sess.getSignoutTime().getTime() > b.getTime() &&
// sess.getSigninTime().getTime() < a.getTime()))
// return true;
// }
// return false;
// }
...
// if (Util.dayFormat.format(signin).equals(dayString) ||
// Util.dayFormat.format(signout).equals(dayString))
// return true;
// }
// return false;
// }
