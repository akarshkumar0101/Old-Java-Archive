...
public class AdminView extends View {
	...
	private class ContentPanel extends JPanel {
		...
		private final ArrayList<VolLabel> volLabels = new ArrayList<>();
		...
		private final ImageIcon signedinicon = new ImageIcon(
				Util.getScaledImage("signedin.png", signiniconSize, signiniconSize));
		private final ImageIcon usericon = new ImageIcon(
				Util.getScaledImage("user.png", volButtonPicSize, volButtonPicSize));
		private final ImageIcon removeusericon = new ImageIcon(
				Util.getScaledImage("remove_user.png", volButtonPicSize, volButtonPicSize));
	...
	public AdminView(FGFrame parent) {
		...
		addVolButton = new JButton(new ImageIcon(Util.getScaledImage("add_user.png", bannerPicSize, bannerPicSize)));
		settingsButton = new JButton(new ImageIcon(Util.getScaledImage("settings.png", bannerPicSize, bannerPicSize)));
